...
The process to publish a new package version has attempted to find the middle ground between a hands off approach, and automation. Tending to not lean to heavily into automation.
